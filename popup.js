...
/**Add Release Note Sub-Task Function */
...
window.onload = () => {
  ...
  /**Seahorse SC-Y Button - Sub-Tasks Created */
  document.getElementById('scYesSea').onclick = () => {
    ...
    /**Contributor SC-Y Button - Sub-Tasks Created */
  ...
  /**Release Note Button - Sub-Tasks Created */
  ...
  /**Windows Button - Tasks Created */
  document.getElementById('winTask').onclick = () => {
    document.getElementById('loader').style.display = "block";
    ...
    addTask({
      "fields":{
        ...
        "customfield_14800":"Cerner Text Editor",
        "customfield_14801":"Text Control Net",
        "customfield_14802":"APE_WINDOWS",
        "summary":"Research and Document Product Info",
        "description":"",
        "issuetype":{
          "id": "3"
        }
    ...
    console.log("Research and Document Product Info Task Sent");
    ...
    addTask({
      "fields":{
        ...
        "customfield_14801":"Text Control Net",
        "customfield_14802":"APE_WINDOWS",
        "summary":"Download Latest Software",
        "description":"",
        "issuetype":{
          "id": "3"
        }
    ...
    console.log("Download Latest Software Task Sent");
    ...
    addTask({
      "fields":{
        ...
        "customfield_14801":"Text Control Net",
        "customfield_14802":"APE_WINDOWS",
        "summary":"Test Building with Latest Software",
        "description":"",
        "issuetype":{
          "id": "3"
        }
    ...
    console.log("Test Building with Latest Software Task Sent");
    ...
    addTask({
      "fields":{
        ...
        "customfield_14801":"Text Control Net",
        "customfield_14802":"APE_WINDOWS",
        "summary":"Notify Consuming Teams of Upgrade",
        "description":"",
        "issuetype":{
          "id": "3"
        }
    ...
    console.log("Notify Consuming Teams of Upgrade Task Sent");
    ...
    addTask({
      "fields":{
        ...
        "customfield_14801":"Text Control Net",
        "customfield_14802":"APE_WINDOWS",
        "summary":"Coordinate Merge with Millennium Support",
        "description":"",
        "issuetype":{
          "id": "3"
        }
    ...
    console.log("Coordinate Merge with Millennium Support Task Sent");
  };
